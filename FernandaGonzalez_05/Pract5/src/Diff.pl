/**
  ...
  * Tema : Operadores de corte y listas diferenciables.
...
/**
  * @arg nat. Lista de listas.
  * @arg nat. Lista con todos los elementos del primer argumento.
  * Versión de la relación flatten que utiliza listas diferenciables.
  **/
flattendif(XS,XY) :- flattendifl(XS, XY-[]).
...
/**
  * @arg nat. Lista de listas.
  * @arg nat. Lista con todos los elementos del primer argumento.
  * Relación auxiliar que ejecuta el flattlen que utiliza listas diferenciables.
  **/
flattendifl([], X-X).
flattendifl([X|XS], Y-Z) :- flattendifl(X, Y-W), flattendifl(XS, W-Z).
flattendifl(X, [X|XS]-XS).
